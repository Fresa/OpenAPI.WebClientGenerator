...
internal sealed class OperationGenerator(
    ...
    SecurityRequirementGenerator? securityRequirementGenerator)
{
    ...
    public SecurityRequirementGenerator? SecurityRequirementGenerator { get; } = securityRequirementGenerator;
}